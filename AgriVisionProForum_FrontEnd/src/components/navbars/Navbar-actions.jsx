    ...
    return (
        <nav className="px-3">
            <div className="nav-logo-container">
                <img src="/Agrivision_Primary_Logo.png" alt="logo" className="h-[30px] w-full" />
            </div>
            <div className="navbar-links-container hidden md:flex ml-4">
                <Link
                    to="/home"
                    className="relative inline-block px-3 py-2 text-black after:content-[''] after:absolute after:left-0 after:bottom-0 after:h-[3px] after:w-0 after:bg-[#C1E1C1] after:transition-all after:duration-300 hover:after:w-full hover:after:bg-emerald-500 hover:text-emerald-600"
                >
                    Home
                </Link>
                <Link
