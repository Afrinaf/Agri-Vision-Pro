  ...
  return (
    <div className="contact-page-wrapper flex flex-col items-center justify-center min-h-screen" id="contact-id">
      ...
      >
        ...
        {/* <button className="primary-button-new w-full text-black">
          <Link to="http://localhost:3000/home" className="w-full block text-center">
            Forum
          </Link>
        </button> */}
        <button className="primary-button-new w-full text-black">
        ...
        <button className="primary-button-new w-full text-black">
           <Link to="/state-map" className="w-full block text-center">
             State Wise Map
           </Link>
        </button>
        <button className="primary-button-new w-full text-black">
           <Link to="/chatbot" className="w-full block text-center">
             Chatbot
           </Link>
        </button>
      </div>
