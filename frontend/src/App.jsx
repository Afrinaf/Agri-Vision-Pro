...
import TamilNaduDashboard from "./pages/dashboard/TamilNaduDashboard";
...
import StateWiseMap from "./components/StateWiseMap";
  ...
  return (
    <>
      <Routes>
        ...
        <Route path="/dashboard/tamilnadu" element={authUser ? <TamilNaduDashboard /> : <Navigate to={"/"} />} />
        ...
        <Route path="/state-map" element={<StateWiseMap />} />
