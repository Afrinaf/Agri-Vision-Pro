    ...
    const handleLike = async () => {
        try {
            const endpoint = isLiked
                ? `http://localhost:5005/api/post/unlikepost/${props.post._id}`
                : `http://localhost:5005/api/post/likepost/${props.post._id}`;
        ...
        <div className="w-full flex items-center justify-center p-5 mb-12">
            <div className="w-4/7 rounded-lg p-10 border-2 shadow-[3px_-2px_19px_13px_#00000024]">
                ...
                <div className='border-2 rounded-xl border-black p-4 mb-3'>
                    ...
                    <div className="mb-4">
                        <img
                            src={`http://localhost:5005/api/post/getpostimage/${props.post._id}`}
                            alt="Dynamic Content"
