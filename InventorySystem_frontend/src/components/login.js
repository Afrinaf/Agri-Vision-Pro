...
//                             <h2 className="text-4xl font-bold text-[#2a4b3c] mb-2">Welcome Back</h2>
...
//                                 <input
//                                     onChange={handleCredentialChnage}
//                                     name="email"
//                                     type="email"
//                                     autoComplete="email"
//                                     required
...
//                                 <Link to="/forgotpassword" className="text-sm text-[#6a9b7d] hover:text-[#5a8a6d] transition-colors">
//                                     Forgot Password?
//                                 </Link>
//                             </div>
...
//                                 <Link to="/signup" className="text-[#6a9b7d] hover:text-[#5a8a6d] transition-colors">
//                                     Create account
//                                 </Link>
//                             </p>
...
//                                         key={provider}
//                                         type="button"
//                                         className="p-3 rounded-xl border border-[#C1E1C1] hover:border-[#AED6AE] bg-white hover:bg-[#f8fcf9] transition-all duration-200"
//                                     >
//                                         <img 
